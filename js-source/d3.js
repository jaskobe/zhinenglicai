;!
    function() {
        ...
        function z(n, t) {
            ...
            return n = ta.ns.qualify(n), null == t ? n.local ? r : e : "function" == typeof t ? n.local ? o : a : n.local ? i : u
        }
        function q(n) {
        ...
        function V(n) {
            ...
            return function(r, u, i) {
                var a, o = n[i].update,
                    c = o.length;
                for (i != e && (e = i, t = 0), u >= t && (t = u + 1); !(a = o[t]) && ++t < c;);
                return a
            }
        }
        function X(n, t, e) {
            ...
            o > 0 && (n = n.slice(0, o));
            var l = ka.get(n);
            return l && (n = l, c = B), o ? t ? u : r : t ? b : i
        }
        function $(n, t) {
            return function(e) {
                var r = ta.event;
        ...
        function W(e) {
            var r = ".dragsuppress-" + ++Ea,
                u = "click" + r,
                i = ta.select(t(e)).on("touchmove" + r, S).on("dragstart" + r, S).on("selectstart" + r, S);
            if (null == Na && (Na = "onselectstart" in e ? !1 : x(e.style, "userSelect")), Na) {
                var a = n(e).style,
                    o = a[Na];
                a[Na] = "none"
            }
            return function(n) {
                if (i.on(r, null), Na && (a[Na] = o), n) {
                    var t = function() {
                        i.on(u, null)
                    };
                    i.on(u, function() {
        ...
        function J(n, e) {
            ...
            if (r.createSVGPoint) {
                ...
                return Aa ? (u.x = e.pageX, u.y = e.pageY) : (u.x = e.clientX, u.y = e.clientY), u = u.matrixTransform(n.getScreenCTM().inverse()), [u.x, u.y]
            }
        ...
        function sn(n, t, e) {
            return this instanceof sn ? (this.h = +n, this.c = +t, void(this.l = +e)) : arguments.length < 2 ? n instanceof sn ? new sn(n.h, n.c, n.l) : n instanceof hn ? pn(n.l, n.a, n.b) : pn((n = Sn((n = ta.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : new sn(n, t, e)
        }
        function fn(n, t, e) {
            return isNaN(n) && (n = 0), isNaN(t) && (t = 0), new hn(e, Math.cos(n *= Da) * t, Math.sin(n) * t)
        }
        function hn(n, t, e) {
        ...
        function gn(n, t, e) {
            var r = (n + 16) / 116,
                u = r + t / 500,
                i = r - e / 200;
            return u = vn(u) * Xa, r = vn(r) * $a, i = vn(i) * Ba, new yn(mn(3.2404542 * u - 1.5371385 * r - .4985314 * i), mn(-.969266 * u + 1.8760108 * r + .041556 * i), mn(.0556434 * u - .2040259 * r + 1.0572252 * i))
        }
        function pn(n, t, e) {
            return n > 0 ? new sn(Math.atan2(e, t) * Pa, Math.sqrt(t * t + e * e), n) : new sn(NaN, NaN, n)
        }
        function vn(n) {
        ...
        function yn(n, t, e) {
            return this instanceof yn ? (this.r = ~~n, this.g = ~~t, void(this.b = ~~e)) : arguments.length < 2 ? n instanceof yn ? new yn(n.r, n.g, n.b) : _n("" + n, yn, ln) : new yn(n, t, e)
        }
        function Mn(n) {
        ...
        function _n(n, t, e) {
            ...
            return (i = Ga.get(n)) ? t(i.r, i.g, i.b) : (null == n || "#" !== n.charAt(0) || isNaN(i = parseInt(n.slice(1), 16)) || (4 === n.length ? (a = (3840 & i) >> 4, a = a >> 4 | a, o = 240 & i, o = o >> 4 | o, c = 15 & i, c = c << 4 | c) : 7 === n.length && (a = (16711680 & i) >> 16, o = (65280 & i) >> 8, c = 255 & i)), t(a, o, c))
        }
        function wn(n, t, e) {
            var r, u, i = Math.min(n /= 255, t /= 255, e /= 255),
                ...
                o = a - i,
                c = (a + i) / 2;
            return o ? (u = .5 > c ? o / (a + i) : o / (2 - a - i), r = n == a ? (t - e) / o + (e > t ? 6 : 0) : t == a ? (e - n) / o + 2 : (n - t) / o + 4, r *= 60) : (r = NaN, u = c > 0 && 1 > c ? 0 : r), new cn(r, u, c)
        }
        function Sn(n, t, e) {
            n = kn(n), t = kn(t), e = kn(e);
            var r = dn((.4124564 * n + .3575761 * t + .1804375 * e) / Xa),
                u = dn((.2126729 * n + .7151522 * t + .072175 * e) / $a),
                i = dn((.0193339 * n + .119192 * t + .9503041 * e) / Ba);
        ...
        function Cn(n, t, e, r) {
            function u() {
                ...
                if (!t && qn(c) || t >= 200 && 300 > t || 304 === t) {
                    ...
                    a.load.call(i, n)
                } else a.error.call(i, c)
            }
            var i = {},
                a = ta.dispatch("beforesend", "progress", "load", "error"),
                o = {},
            ...
            return !this.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload" in c ? c.onload = c.onerror = u : c.onreadystatechange = function() {
                ...
                if (2 === arguments.length && "function" == typeof r && (u = r, r = null), c.open(e, n, !0), null == t || "accept" in o || (o.accept = t + ",*/*"), c.setRequestHeader) for (var s in o) c.setRequestHeader(s, o[s]);
                return null != t && c.overrideMimeType && c.overrideMimeType(t), null != l && (c.responseType = l), null != u && i.on("error", u).on("load", function(n) {
                    u(null, n)
                }), a.beforesend.call(i, c), c.send(null == r ? null : r), i
            }, i.abort = function() {
                return c.abort(), i
            }, ta.rebind(i, a, "on"), null == r ? i : i.get(zn(r))
        }
        function zn(n) {
            return 1 === n.length ?
                function(t, e) {
        ...
        function Ln() {
            var n = Tn(),
                t = Rn() - n;
            t > 24 ? (isFinite(t) && (clearTimeout(to), to = setTimeout(Ln, t)), no = 0) : (no = 1, ro(Ln))
        }
        function Tn() {
            var n = Date.now();
            for (eo = Ka; eo;) n >= eo.t && (eo.f = eo.c(n - eo.t)), eo = eo.n;
            return n
        }
        function Rn() {
        ...
        function Un(n) {
            ...
            return function(n) {
                var e = io.exec(n),
                    ...
                    m = !1,
                    y = !0;
                switch (h && (h = +h.substring(1)), (l || "0" === r && "=" === a) && (l = r = "0", a = "="), g) {
                    case "n":
                        f = !0, g = "g";
                        break;
                    case "%":
                ...
                "$" === c && (v = u[0], d = u[1]), "r" != g || h || (g = "g"), null != h && ("g" == g ? h = Math.max(1, Math.min(21, h)) : ("e" == g || "f" == g) && (h = Math.max(0, Math.min(20, h)))), g = ao.get(g) || jn;
                var M = l && f;
                return function(n) {
                    var e = d;
                    if (m && n % 1) return "";
        ...
        function Hn(n, t, e) {
            ...
            function u(e) {
                return t(e = n(new co(e - 1)), 1), e
            }
            function i(n, e) {
                return t(n = new co(+n), e), n
            }
            function a(n, r, i) {
                var a = u(n),
                    o = [];
            ...
            var c = n.utc = On(n);
            return c.floor = c, c.round = On(r), c.ceil = On(u), c.offset = On(i), c.range = o, n
        }
        function On(n) {
            return function(t, e) {
                try {
        ...
        function In(n) {
            function t(n) {
                function t(t) {
                    for (var e, u, i, a = [], o = -1, c = 0; ++o < r;) 37 === n.charCodeAt(o) && (a.push(n.slice(c, o)), null != (u = so[e = n.charAt(++o)]) && (e = n.charAt(++o)), (i = A[e]) && (e = i(t, null == u ? "e" === e ? " " : "0" : u)), a.push(e), c = o + 1);
                    return a.push(n.slice(c, o)), a.join("")
                }
                var r = n.length;
            ...
            function e(n, t, e, r) {
                for (var u, i, a, o = 0, c = t.length, l = e.length; c > o;) {
                    if (r >= l) return -1;
                    if (u = t.charCodeAt(o++), 37 === u) {
                        if (a = t.charAt(o++), i = C[a in so ? t.charAt(o++) : a], !i || (r = i(n, e, r)) < 0) return -1
            ...
            var A = {
                    ...
                    j: function(n, t) {
                        return Yn(1 + oo.dayOfYear(n), t, 3)
                    },
                    L: function(n, t) {
                    ...
                    U: function(n, t) {
                        return Yn(oo.sundayOfYear(n), t, 2)
                    },
                    w: function(n) {
                        return n.getDay()
                    },
                    W: function(n, t) {
                        return Yn(oo.mondayOfYear(n), t, 2)
                    },
                    x: t(h),
                    X: t(g),
                    y: function(n, t) {
        ...
        function Xn(n, t, e) {
            fo.lastIndex = 0;
            var r = fo.exec(t.slice(e, e + 1));
            return r ? (n.w = +r[0], e + r[0].length) : -1
        }
        function $n(n, t, e) {
            fo.lastIndex = 0;
            var r = fo.exec(t.slice(e));
        ...
        function Wn(n, t, e) {
            fo.lastIndex = 0;
            var r = fo.exec(t.slice(e, e + 4));
            return r ? (n.y = +r[0], e + r[0].length) : -1
        }
        function Jn(n, t, e) {
            fo.lastIndex = 0;
            var r = fo.exec(t.slice(e, e + 2));
        ...
        function pt() {
            function n(n, t) {
                ...
                var e = n - r,
                    ...
                    f = u * c + s * Math.cos(o),
                    h = s * a * Math.sin(o);
                Mo.add(Math.atan2(h, f)), r = n, u = c, i = l
            }
            var t, e, r, u, i;
            xo.point = function(a, o) {
                xo.point = n, r = (t = a) * Da, u = Math.cos(o = (e = o) * Da / 2 + qa / 4), i = Math.sin(o)
            }, xo.lineEnd = function() {
                n(t, e)
            }
        }
        ...
        function St(n, t, e) {
            ++bo, wo += (n - wo) / bo, So += (t - So) / bo, ko += (e - ko) / bo
        }
        function kt() {
            function n(n, u) {
                n *= Da;
                ...
                _o += l, No += l * (t + (t = a)), Eo += l * (e + (e = o)), Ao += l * (r + (r = c)), St(t, e, r)
            }
            var t, e, r;
            Lo.point = function(u, i) {
                u *= Da;
                var a = Math.cos(i *= Da);
                t = a * Math.cos(u), e = a * Math.sin(u), r = Math.sin(i), Lo.point = n, St(t, e, r)
            }
        }
        function Nt() {
            Lo.point = wt
        ...
        function Et() {
            function n(n, t) {
                ...
                var e = Math.cos(t *= Da),
                    ...
                    p = h && -nn(g) / h,
                    v = Math.atan2(h, g);
                Co += p * l, zo += p * s, qo += p * f, _o += v, No += v * (r + (r = a)), Eo += v * (u + (u = o)), Ao += v * (i + (i = c)), St(r, u, i)
            }
            var t, e, r, u, i;
            Lo.point = function(a, o) {
                t = a, e = o, Lo.point = n, a *= Da;
                var c = Math.cos(o *= Da);
                r = c * Math.cos(a), u = c * Math.sin(a), i = Math.sin(o), St(r, u, i)
            }, Lo.lineEnd = function() {
                n(t, e), Lo.lineEnd = Nt, Lo.point = wt
            }
        }
        function At(n, t) {
            function e(e, r) {
            ...
            if (n.forEach(function(n) {
                    if (!((t = n.length - 1) <= 0)) {
                        ...
                        var c = new Lt(e, n, null, !0),
                            l = new Lt(e, null, c, !1);
                        c.o = l, i.push(c), a.push(l), c = new Lt(r, n, null, !1), l = new Lt(r, null, c, !0), c.o = l, i.push(c), a.push(l)
                    }
                }), a.sort(t), qt(i), qt(a), i.length) {
                for (var o = 0, c = e, l = a.length; l > o; ++o) a[o].e = c = !c;
                for (var s, f, h = i[0];;) {
                    for (var g = h, p = !0; g.v;) if ((g = g.n) === h) return;
                    s = g.z, u.lineStart();
                    do {
                        if (g.v = g.o.v = !0, g.e) {
                            if (p) for (var o = 0, l = s.length; l > o; ++o) u.point((f = s[o])[0], f[1]);
        ...
        function Tt(n, t, e, r) {
            return function(u, i) {
                ...
                function h() {
                    ...
                    } else r > 1 && 2 & t && e.push(e.pop().concat(e.shift())), g.push(e.filter(Rt))
                }
                var g, p, v, d = t(i),
                    m = u.invert(r[0], r[1]),
                    y = {
                        ...
                        polygonEnd: function() {
                            y.point = a, y.lineStart = c, y.lineEnd = l, g = ta.merge(g);
                            var n = Ht(m, p);
                            g.length ? (b || (i.polygonStart(), b = !0), zt(g, Pt, n, e, i)) : n && (b || (i.polygonStart(), b = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()), b && (i.polygonEnd(), b = !1), g = p = null
                        },
                        sphere: function() {
        ...
        function Ut(n) {
            ...
            return {
                ...
                point: function(i, a) {
                    var o = i > 0 ? qa : -qa,
                        c = ga(i - e);
                    ga(c - qa) < Ca ? (n.point(e, r = (r + a) / 2 > 0 ? Ra : -Ra), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(i, r), t = 0) : u !== o && c >= qa && (ga(e - u) < Ca && (e -= u * Ca), ga(i - o) < Ca && (i -= o * Ca), r = jt(e, r, i, a), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), t = 0), n.point(e = i, r = a), u = o
                },
                lineEnd: function() {
                    n.lineEnd(), e = r = NaN
                },
        ...
        function jt(n, t, e, r) {
            ...
            return ga(a) > Ca ? Math.atan((Math.sin(t) * (i = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (u = Math.cos(t)) * Math.sin(n)) / (u * i * a)) : (t + r) / 2
        }
        function Ft(n, t, e, r) {
            var u;
            ...
            for (var o = 0, c = t.length; c > o; ++o) {
                ...
                if (s) for (var f = l[0], h = f[0], g = f[1] / 2 + qa / 4, p = Math.sin(g), v = Math.cos(g), d = 1;;) {
                    ...
                    var m = n[0],
                        ...
                        S = w > qa,
                        k = p * M;
                    if (Mo.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))), i += S ? b + _ * La : b, S ^ h >= e ^ m >= e) {
                        var N = mt(vt(f), vt(n));
                        xt(N);
                        var E = mt(u, N);
                        xt(E);
            ...
            function e(n) {
                ...
                return {
                    ...
                    point: function(f, h) {
                        var g, p = [f, h],
                            v = t(f, h),
                            d = a ? v ? 0 : u(f, h) : v ? u(f + (0 > f ? qa : -qa), h) : 0;
                        if (!e && (l = c = v) && n.lineStart(), v !== c && (g = r(e, p), (_t(e, g) || _t(p, g)) && (p[0] += Ca, p[1] += Ca, v = t(p[0], p[1]))), v !== c) s = 0, v ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                        else if (o && e && a ^ v) {
                            var m;
                        ...
                        }!v || e && _t(e, p) || n.point(p[0], p[1]), e = p, c = v, i = d
                    },
                    lineEnd: function() {
                        c && n.lineEnd(), e = null
                    },
            ...
            function r(n, t, e) {
                ...
                if (!(0 > M)) {
                    ...
                    var E = S - w,
                        A = ga(E - qa) < Ca,
                        C = A || Ca > E;
                    if (!A && k > N && (_ = k, k = N, N = _), C ? A ? k + N > 0 ^ b[1] < (ga(b[0] - w) < Ca ? k : N) : k <= b[1] && b[1] <= N : E > qa ^ (w <= b[0] && b[0] <= S)) {
                        var z = Mt(d, (-m + x) / y);
                        return yt(z, p), [b, bt(z)]
                    }
                }
            }
            function u(t, e) {
        ...
        function Yt(n, t, e, r) {
            ...
            return function(o) {
                function c(n) {
                    for (var t = 0, e = d.length, r = n[1], u = 0; e > u; ++u) for (var i, a = 1, o = d[u], c = o.length, l = o[0]; c > a; ++a) i = o[a], l[1] <= r ? i[1] > r && Q(l, i, n) > 0 && ++t : i[1] <= r && Q(l, i, n) < 0 && --t, l = i;
                    return 0 !== t
                }
                function l(i, o, c, l) {
                    var s = 0,
                        f = 0;
                    if (null == i || (s = u(i, c)) !== (f = u(o, c)) || a(i, o) < 0 ^ c > 0) {
                    ...
                    C = {
                        ...
                        polygonEnd: function() {
                            ...
                            var t = c([n, r]),
                                e = k && t,
                                u = v.length;
                            (e || u) && (o.polygonStart(), e && (o.lineStart(), l(null, null, 1, o), o.lineEnd()), u && zt(v, i, t, l, o), o.polygonEnd()), v = d = m = null
                        }
                    };
                return C
            }
        ...
        function Xt() {
            ...
            var t, e, r, u;
            Oo.point = function(i, a) {
                Oo.point = n, t = r = i, e = u = a
            }, Oo.lineEnd = function() {
                n(t, e)
            }
        }
        function $t(n, t) {
            Uo > n && (Uo = n), n > Fo && (Fo = n), jo > t && (jo = t), t > Ho && (Ho = t)
        }
        function Bt() {
            function n(n, t) {
                a.push("M", n, ",", t, i)
        ...
        function Gt() {
            function n(n, r) {
                var u = n - t,
                    i = r - e,
                    a = Math.sqrt(u * u + i * i);
                No += a * (t + n) / 2, Eo += a * (e + r) / 2, Ao += a, Jt(t = n, e = r)
            }
            var t, e;
            Yo.point = function(r, u) {
                Yo.point = n, Jt(t = r, e = u)
            }
        }
        function Kt() {
            Yo.point = Jt
        ...
        function Qt() {
            function n(n, t) {
                var e = n - r,
                    i = t - u,
                    a = Math.sqrt(e * e + i * i);
                No += a * (r + n) / 2, Eo += a * (u + t) / 2, Ao += a, a = u * n - r * t, Co += a * (r + n), zo += a * (u + t), qo += 3 * a, Jt(r = n, u = t)
            }
            var t, e, r, u;
            Yo.point = function(i, a) {
                Yo.point = n, Jt(t = r = i, e = u = a)
            }, Yo.lineEnd = function() {
                n(t, e)
            }
        }
        function ne(n) {
            function t(t, e) {
                n.moveTo(t + a, e), n.arc(t, e, a, 0, La)
            }
            function e(t, e) {
        ...
        function te(n) {
            ...
            function u(t, e, r, o, c, l, s, f, h, g, p, v, d, m) {
                var y = s - t,
                    M = f - e,
                    x = y * y + M * M;
                if (x > 4 * i && d--) {
                    var b = o + g,
                        ...
                        k = Math.asin(w /= S),
                        N = ga(ga(w) - 1) < Ca || ga(r - h) < Ca ? (r + h) / 2 : Math.atan2(_, b),
                        E = n(N, k),
                        A = E[0],
                        C = E[1],
                        z = A - t,
                        q = C - e,
                        L = M * z - y * q;
                    (L * L / x > i || ga((y * z + M * q) / x - .5) > .3 || a > o * g + c * p + l * v) && (u(t, e, r, o, c, l, A, C, N, b /= S, _ /= S, w, d, m), m.point(A, C), u(A, C, N, b, _, w, s, f, h, g, p, v, d, m))
                }
            }
            var i = .5,
                a = Math.cos(30 * Da),
        ...
        function ae(n) {
            function t(n) {
                return n = o(n[0] * Da, n[1] * Da), [n[0] * h + c, l - n[1] * h]
            }
            function e(n) {
                return n = o.invert((n[0] - c) / h, (l - n[1]) / h), n && [n[0] * Pa, n[1] * Pa]
            }
            function r() {
                o = At(a = se(m, M, x), i);
                var n = i(v, d);
            ...
            var i, a, o, c, l, s, f = te(function(n, t) {
            ...
            return t.stream = function(n) {
                return s && (s.valid = !1), s = oe(b(a, f(_(n)))), s.valid = !0, s
            }, t.clipAngle = function(n) {
                return arguments.length ? (b = null == n ? (w = n, To) : Ot((w = +n) * Da), u()) : w
            }, t.clipExtent = function(n) {
                return arguments.length ? (S = n, _ = n ? Yt(n[0][0], n[0][1], n[1][0], n[1][1]) : y, u()) : S
            }, t.scale = function(n) {
        ...
        function se(n, t, e) {
            return n ? t || e ? At(he(n), ge(t, e)) : he(n) : t || e ? ge(t, e) : le
        }
        function fe(n) {
            return function(t, e) {
        ...
        function ge(n, t) {
            function e(n, t) {
                var e = Math.cos(t),
                    ...
                    l = Math.sin(t),
                    s = l * r + o * u;
                return [Math.atan2(c * i - s * a, o * r - l * u), tn(s * i + c * a)]
            }
            var r = Math.cos(n),
                u = Math.sin(n),
                i = Math.cos(t),
            ...
            return e.invert = function(n, t) {
                var e = Math.cos(t),
                    ...
                    l = Math.sin(t),
                    s = l * i - c * a;
                return [Math.atan2(c * i + l * a, o * r + s * u), tn(s * r - o * u)]
            }, e
        }
        function pe(n, t) {
            var e = Math.cos(n),
            ...
            return function(u, i, a, o) {
                var c = a * t;
                null != u ? (u = ve(e, u), i = ve(e, i), (a > 0 ? i > u : u > i) && (u += a * La)) : (u = n + a * La, i = n - .5 * c);
                for (var l, s = u; a > 0 ? s > i : i > s; s -= c) o.point((l = bt([e, -r * Math.cos(s), -r * Math.sin(s)]))[0], l[1])
            }
        }
        function ve(n, t) {
            var e = vt(t);
        ...
        function be() {
            function n(n, u) {
                var i = Math.sin(u *= Da),
                    ...
                    o = ga((n *= Da) - t),
                    c = Math.cos(o);
                Zo += Math.atan2(Math.sqrt((o = a * Math.sin(o)) * o + (o = r * i - e * a * c) * o), e * i + r * a * c), t = n, e = i, r = a
            }
            var t, e, r;
            Vo.point = function(u, i) {
                t = u * Da, e = Math.sin(i *= Da), r = Math.cos(i), Vo.point = n
            }, Vo.lineEnd = function() {
                Vo.point = Vo.lineEnd = b
            }
        }
        function _e(n, t) {
            function e(t, e) {
        ...
        function we(n, t) {
            function e(n, t) {
                a > 0 ? -Ra + Ca > t && (t = -Ra + Ca) : t > Ra - Ca && (t = Ra - Ca);
            ...
            return i ? (e.invert = function(n, t) {
                ...
                return [Math.atan2(n, e) / i, 2 * Math.atan(Math.pow(a / r, 1 / i)) - Ra]
            }, e) : ke
        }
        function Se(n, t) {
            function e(n, t) {
            ...
            var r = Math.cos(n),
                ...
                i = r / u + n;
            return ga(u) < Ca ? ce : (e.invert = function(n, t) {
                var e = i - t;
        ...
        function Ue(n) {
            $e(n), nc.remove(n), rc.push(n), er(n)
        }
        function je(n) {
            var t = n.circle,
                e = t.x,
                ...
                o = [n];
            Ue(n);
            for (var c = i; c.circle && ga(e - c.circle.x) < Ca && ga(r - c.circle.cy) < Ca;) i = c.P, o.unshift(c), Ue(c), c = i;
            o.unshift(c), $e(c);
            for (var l = a; l.circle && ga(e - l.circle.x) < Ca && ga(r - l.circle.cy) < Ca;) a = l.N, o.push(l), Ue(l), l = a;
            o.push(l), $e(l);
            var s, f = o.length;
            for (s = 1; f > s; ++s) l = o[s], c = o[s - 1], Qe(l.edge, c.site, l.site, u);
            c = o[0], l = o[f - 1], l.edge = Ge(c.site, l.site, null, u), Xe(c), Xe(l)
        }
        function Fe(n) {
            for (var t, e, r, u, i = n.x, a = n.y, o = nc._; o;) if (r = He(o, a) - i, r > Ca) o = o.L;
            else {
                if (u = i - Oe(o, a), !(u > Ca)) {
                    r > -Ca ? (t = o.P, e = o) : u > -Ca ? (t = o, e = o.N) : t = e = o;
                    break
                }
                if (!o.R) {
                    t = o;
            ...
            var c = Pe(n);
            if (nc.insert(t, c), t || e) {
                if (t === e) return $e(t), e = Pe(t.site), nc.insert(c, e), c.edge = e.edge = Ge(t.site, c.site), Xe(t), void Xe(e);
                ...
                Qe(e.edge, l, p, x), c.edge = Ge(l, n, null, x), e.edge = Ge(n, p, null, x), Xe(t), Xe(e)
            }
        }
        function He(n, t) {
            var e = n.site,
            ...
            var s = o - r,
                f = 1 / i - 1 / l,
                h = s / l;
            return f ? (-h + Math.sqrt(h * h - 2 * f * (s * s / (-2 * l) - c + l / 2 + u - i / 2))) / f + r : (r + o) / 2
        }
        function Oe(n, t) {
            var e = n.N;
            if (e) return He(e, t);
        ...
        function Ye(n) {
            for (var t, e, r, u, i, a, o, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Qo, d = v.length; d--;) if (i = v[d], i && i.prepare()) for (o = i.edges, c = o.length, a = 0; c > a;) s = o[a].end(), r = s.x, u = s.y, l = o[++a % c].start(), t = l.x, e = l.y, (ga(r - t) > Ca || ga(u - e) > Ca) && (o.splice(a, 0, new nr(Ke(i.site, s, ga(r - f) < Ca && p - u > Ca ? {
                x: f,
                y: ga(t - f) < Ca ? e : p
            } : ga(u - p) < Ca && h - r > Ca ? {
                x: ga(e - p) < Ca ? t : h,
            ...
            if (t && e) {
                ...
                if (r !== i) {
                    ...
                    if (!(h >= -za)) {
                        ...
                        for (var y = null, M = ec._; M;) if (m.y < M.y || m.y === M.y && m.x <= M.x) {
                            if (!M.L) {
                                y = M.P;
                                break
                            }
        ...
        function $e(n) {
            var t = n.circle;
            t && (t.P || (tc = t.N), ec.remove(t), uc.push(t), er(t), n.circle = null)
        }
        function Be(n) {
            for (var t, e = Ko, r = It(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;) t = e[u], (!We(t, n) || !r(t) || ga(t.a.x - t.b.x) < Ca && ga(t.a.y - t.b.y) < Ca) && (t.a = t.b = null, e.splice(u, 1))
        }
        function We(n, t) {
            var e = n.b;
            if (e) return !0;
        ...
        function Ge(n, t, e, r) {
            var u = new Je(n, t);
            return Ko.push(u), e && Qe(u, n, t, e), r && Qe(u, t, n, r), Qo[n.i].edges.push(new nr(u, n, t)), Qo[t.i].edges.push(new nr(u, t, n)), u
        }
        function Ke(n, t, e) {
            var r = new Je(n, null);
            return r.a = t, r.b = e, Ko.push(r), r
        }
        function Qe(n, t, e, r) {
        ...
        function ar(n, t) {
            var e, r, u, i = n.sort(or).pop();
            for (Ko = [], Qo = new Array(n.length), nc = new tr, ec = new tr;;) if (u = tc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== e || i.y !== r) && (Qo[i.i] = new Ie(i), Fe(i), e = i.x, r = i.y), i = n.pop();
            else {
                if (!u) break;
                je(u.arc)
            }
        ...
        function hr(n, t, e, r, u, i) {
            if (!n(t, e, r, u, i)) {
                var a = .5 * (e + u),
                    o = .5 * (r + i),
                    c = t.nodes;
                c[0] && hr(n, c[0], e, r, a, o), c[1] && hr(n, c[1], a, r, u, o), c[2] && hr(n, c[2], e, o, a, i), c[3] && hr(n, c[3], a, o, u, i)
            }
        }
        function gr(n, t, e, r, u, i, a) {
            var o, c = 1 / 0;
        ...
        function vr(n, t) {
            var e, r = {},
                u = {};
            for (e in n) e in t ? r[e] = yr(n[e], t[e]) : u[e] = n[e];
        ...
        function mr(n, t) {
            var e, r, u, i = ac.lastIndex = oc.lastIndex = 0,
                a = -1,
                o = [],
                c = [];
            for (n += "", t += "";
                 (e = ac.exec(n)) && (r = oc.exec(t));)(u = r.index) > i && (u = t.slice(i, u), o[a] ? o[a] += u : o[++a] = u), (e = e[0]) === (r = r[0]) ? o[a] ? o[a] += r : o[++a] = r : (o[++a] = null, c.push({
                i: a,
                x: dr(e, r)
            })), i = oc.lastIndex;
            return i < t.length && (u = t.slice(i), o[a] ? o[a] += u : o[++a] = u), o.length < 2 ? c[0] ? (t = c[0].x, function(n) {
                return t(n) + ""
            }) : function() {
                return t
            } : (t = c.length, function(n) {
                for (var e, r = 0; t > r; ++r) o[(e = c[r]).i] = e.x(n);
                return o.join("")
            })
        }
        function yr(n, t) {
        ...
        function Zr(n) {
            for (var t = n.source, e = n.target, r = Xr(t, e), u = [t]; t !== r;) t = t.parent, u.push(t);
        ...
        function Xr(n, t) {
            if (n === t) return n;
            for (var e = Vr(n), r = Vr(t), u = e.pop(), i = r.pop(), a = null; u === i;) a = u, u = e.pop(), i = r.pop();
            return a
        }
        function $r(n) {
            n.fixed |= 2
        ...
        function Gr(n, t, e) {
            var r = 0,
                u = 0;
            if (n.charge = 0, !n.leaf) for (var i, a = n.nodes, o = a.length, c = -1; ++c < o;) i = a[c], null != i && (Gr(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
            if (n.point) {
        ...
        function Kr(n, t) {
            return ta.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = uu, n
        }
        function Qr(n, t) {
        ...
        function fu(n) {
            return n.reduce(hu, 0)
        }
        function hu(n, t) {
            return n + t[1]
        }
        function gu(n, t) {
            return pu(n, Math.ceil(Math.log(t.length) / Math.LN2 + 1))
        }
        function pu(n, t) {
        ...
        function xu(n) {
            ...
            if ((e = n.children) && (l = e.length)) {
                var e, r, u, i, a, o, c, l, s = 1 / 0,
                    ...
                    h = 1 / 0,
                    g = -1 / 0;
                if (e.forEach(bu), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), l > 2)) for (i = e[2], Su(r, u, i), t(i), mu(r, i), r._pack_prev = i, mu(i, u), u = r._pack_next, a = 3; l > a; a++) {
                    Su(r, u, i = e[a]);
                    var p = 0,
                        v = 1,
                        d = 1;
                    for (o = u._pack_next; o !== u; o = o._pack_next, v++) if (Mu(o, i)) {
                        p = 1;
                        break
                    }
                    if (1 == p) for (c = r._pack_prev; c !== o._pack_prev && !Mu(c, i); c = c._pack_prev, d++);
                    p ? (d > v || v == d && u.r < r.r ? yu(r, u = o) : yu(r = c, u), a--) : (mu(r, i), u = i, t(i))
                }
                var m = (s + f) / 2,
                    y = (h + g) / 2,
                    M = 0;
        ...
        function wu(n, t, e, r) {
            var u = n.children;
            if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u) for (var i = -1, a = u.length; ++i < a;) wu(u[i], t, e, r)
        }
        function Su(n, t, e) {
            var r = n.r + e.r,
                u = t.x - n.x,
        ...
        function Ru(n) {
            var t, e = n.children;
            return e && (t = e.length) ? Ru(e[t - 1]) : n
        }
        function Du(n) {
            return {
                x: n.x,
        ...
        function Iu(n, t, e, r) {
            ...
            return function(t) {
                var e = ta.bisect(n, t, 1, o) - 1;
                return i[e](u[e](t))
            }
        }
        function Yu(n, t, e, r) {
            function u() {
                var u = Math.min(n.length, t.length) > 2 ? Iu : Fu,
                    c = r ? Yr : Ir;
                return a = u(n, t, c, e), o = u(t, n, c, yr), i
            }
            function i(n) {
                return a(n)
            }
            ...
            return i.invert = function(n) {
                ...
                return i.range(n).interpolate(Pr)
            }, i.clamp = function(n) {
        ...
        function Bu(n, t, e) {
            ...
            if (e) {
                ...
                if (u.shift(), "s" === u[8]) {
                    ...
                    return u[7] || (u[7] = "." + Wu(i.scale(r[2]))), u[8] = "f", e = ta.format(u.join("")), function(n) {
                        return e(i.scale(n)) + i.symbol
                    }
                }
                u[7] || (u[7] = "." + Ju(u[8], r)), e = u.join("")
            } else e = ",." + Wu(r[2]) + "f";
            return ta.format(e)
        }
        function Wu(n) {
        ...
        function Ju(n, t) {
            var e = Wu(t[2]);
            return n in Mc ? Math.abs(e - Wu(Math.max(ga(t[0]), ga(t[1])))) + +("e" !== n) : e - 2 * ("%" === n)
        }
        function Gu(n, t, e, r) {
            function u(n) {
            ...
            return a.invert = function(t) {
                ...
                if (isFinite(s - l)) {
                    if (e) {
                        for (; s > l; l++) for (var h = 1; f > h; h++) a.push(i(l) * h);
                        a.push(i(l))
                    } else for (a.push(i(l)); l++ < s;) for (var h = f - 1; h > 0; h--) a.push(i(l) * h);
                    for (l = 0; a[l] < o; l++);
                ...
                arguments.length < 2 ? t = xc : "function" != typeof t && (t = ta.format(t));
                var r, o = Math.max(.1, n / a.ticks().length),
                    c = e ? (r = 1e-12, Math.ceil) : (r = -1e-12, Math.floor);
                return function(n) {
                    return n / i(c(u(n) + r)) <= o ? t(n) : ""
                }
            }, a.copy = function() {
                return Gu(n.copy(), t, e, r)
            }, Zu(a, n)
        }
        function Ku(n, t, e) {
            function r(t) {
            ...
            return r.invert = function(t) {
                ...
                return r.domain(Vu(e, n))
            }, r.exponent = function(a) {
                return arguments.length ? (u = Qu(t = a), i = Qu(1 / t), n.domain(e.map(u)), r) : t
            }, r.copy = function() {
                return Ku(n.copy(), t, e)
            }, Zu(r, n)
        }
        function Qu(n) {
            return function(t) {
        ...
        function ni(n, t) {
            ...
            return e.domain = function(r) {
                ...
                var c = u[0],
                    l = u[1],
                    s = n.length < 2 ? (c = (c + l) / 2, 0) : (l - c) / (n.length - 1 + o);
                return i = r(c + s * o / 2, s), a = 0, t = {
                    t: "rangePoints",
                    a: arguments
                }, e
                ...
                var c = u[0],
                    l = u[1],
                    s = n.length < 2 ? (c = l = Math.round((c + l) / 2), 0) : (l - c) / (n.length - 1 + o) | 0;
                return i = r(c + Math.round(s * o / 2 + (l - c - (n.length - 1 + o) * s) / 2), s), a = 0, t = {
                    t: "rangeRoundPoints",
                    a: arguments
                }, e
                ...
                return i = r(s + Math.round((f - s - (n.length - o) * h) / 2), h), l && i.reverse(), a = Math.round(h * (1 - o)), t = {
                    t: "rangeRoundBands",
                    a: arguments
                }, e
        ...
        function ti(n, t) {
            function i() {
                var e = 0,
                    r = t.length;
                for (o = []; ++e < r;) o[e - 1] = ta.quantile(n, e / r);
                return a
            }
            function a(n) {
                return isNaN(n = +n) ? void 0 : t[ta.bisect(o, n)]
            }
            var o;
        ...
        function gi(n) {
            function t(t) {
                ...
                for (var c, l = [], s = [], f = -1, h = t.length, g = En(e), p = En(r); ++f < h;) u.call(this, c = t[f], f) ? s.push([+g.call(this, c, f), +p.call(this, c, f)]) : s.length && (a(), s = []);
            ...
            return t.x = function(n) {
                ...
                return arguments.length ? (a = "function" == typeof n ? i = n : (i = Ec.get(n) || pi).key, t) : a
        ...
        function xi(n, t) {
            return n.length < 3 ? pi(n) : n[0] + _i((n.push(n[0]), n), wi([n[n.length - 2]].concat(n, [n[1]]), t))
        }
        function bi(n, t) {
            return n.length < 3 ? pi(n) : n[0] + _i(n, wi(n, t))
        }
        function _i(n, t) {
            if (t.length < 1 || n.length != t.length && n.length != t.length + 2) return pi(n);
            var e = n.length != t.length,
                ...
                o = a,
                c = 1;
            if (e && (r += "Q" + (i[0] - 2 * a[0] / 3) + "," + (i[1] - 2 * a[1] / 3) + "," + i[0] + "," + i[1], u = n[1], c = 2), t.length > 1) {
        ...
        function Si(n) {
            ...
            var t = 1,
                ...
                a = [u, u, u, (r = n[1])[0]],
                o = [i, i, i, r[1]],
                c = [u, ",", i, "L", Ai(zc, a), ",", Ai(zc, o)];
            for (n.push(n[e - 1]); ++t <= e;) r = n[t], a.shift(), a.push(r[0]), o.shift(), o.push(r[1]), Ci(c, a, o);
            return n.pop(), c.push("L", r), c.join("")
        }
        function ki(n) {
            if (n.length < 4) return pi(n);
            for (var t, e = [], r = -1, u = n.length, i = [0], a = [0]; ++r < 3;) t = n[r], i.push(t[0]), a.push(t[1]);
            for (e.push(Ai(zc, i) + "," + Ai(zc, a)), --r; ++r < u;) t = n[r], i.shift(), i.push(t[0]), a.shift(), a.push(t[1]), Ci(e, i, a);
            return e.join("")
        }
        function Ni(n) {
            for (var t, e, r = -1, u = n.length, i = u + 4, a = [], o = []; ++r < 4;) e = n[r % u], a.push(e[0]), o.push(e[1]);
            for (t = [Ai(zc, a), ",", Ai(zc, o)], --r; ++r < i;) e = n[r % u], a.shift(), a.push(e[0]), o.shift(), o.push(e[1]), Ci(t, a, o);
            return t.join("")
        }
        function Ei(n, t) {
            var e = n.length - 1;
        ...
        function Ci(n, t, e) {
            n.push("C", Ai(Ac, t), ",", Ai(Ac, e), ",", Ai(Cc, t), ",", Ai(Cc, e), ",", Ai(zc, t), ",", Ai(zc, e))
        }
        function zi(n, t) {
            return (t[1] - n[1]) / (t[0] - n[0])
        }
        function qi(n) {
            for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], a = r[0] = zi(u, i); ++t < e;) r[t] = (a + (a = zi(u = i, i = n[t + 1]))) / 2;
            return r[t] = a, r
        }
        function Li(n) {
            for (var t, e, r, u, i = [], a = qi(n), o = -1, c = n.length - 1; ++o < c;) t = zi(n[o], n[o + 1]), ga(t) < Ca ? a[o] = a[o + 1] = 0 : (e = a[o] / t, r = a[o + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), a[o] = u * e, a[o + 1] = u * r));
            for (o = -1; ++o <= c;) u = (n[Math.min(c, o + 1)][0] - n[Math.max(0, o - 1)][0]) / (6 * (1 + a[o] * a[o])), i.push([u || 0, a[o] * u || 0]);
            return i
        }
        function Ti(n) {
            return n.length < 3 ? pi(n) : n[0] + _i(n, Li(n))
        }
        function Ri(n) {
        ...
        function Di(n) {
            function t(t) {
                function c() {
                    v.push("M", o(n(m), f), s, l(n(d.reverse()), f), "Z")
                }
                for (var h, g, p, v = [], d = [], m = [], y = -1, M = t.length, x = En(e), b = En(u), _ = e === r ?
                    function() {
                        return g
                    } : En(r), w = u === i ?
                    function() {
                        return p
                    } : En(i); ++y < M;) a.call(this, h = t[y], y) ? (d.push([g = +x.call(this, h, y), p = +b.call(this, h, y)]), m.push([+_.call(this, h, y), +w.call(this, h, y)])) : d.length && (c(), d = [], m = []);
            ...
            return t.x = function(n) {
                ...
                return arguments.length ? (c = "function" == typeof n ? o = n : (o = Ec.get(n) || pi).key, l = o.reverse || o, s = o.closed ? "M" : "L", t) : c
            }, t.tension = function(n) {
        ...
        function Yi(n, t, e) {
            return ya(n, Uc), n.namespace = t, n.id = e, n
        }
        function Zi(n, t, e, r) {
            var u = n.id,
                i = n.namespace;
            ...
            if (!a) {
                ...
                a = i[r] = {
                    ...
                    function c(e) {
                        ...
                        var u = i[i.active];
                        u && (--i.count, delete i[i.active], u.event && u.event.interrupt.call(n, n.__data__, u.index)), i.active = r, a.event && a.event.start.call(n, n.__data__, t), a.tween.forEach(function(e, r) {
                            (r = r.call(n, n.__data__, t)) && v.push(r)
                        }), h = a.ease, f = a.duration, ta.timer(function() {
                            return p.c = l(e || 1) ? Ct : l, 1
                        }, 0, o)
                    }
                    function l(e) {
                        if (i.active !== r) return 1;
                        for (var u = e / f, o = h(u), c = v.length; c > 0;) v[--c].call(n, o);
                        return u >= 1 ? (a.event && a.event.end.call(n, n.__data__, t), s()) : void 0
                    }
                    function s() {
                    ...
                    var f, h, g = a.delay,
                        p = eo,
                        v = [];
                    return p.t = g + o, u >= g ? c(u - g) : void(p.c = c)
                }, 0, o)
            }
        }
        function Bi(n, t, e) {
        ...
        function Gi(n, t, e) {
            ...
            function u(n, e) {
                var r = n[1] - n[0],
                    u = r / e,
                    i = ta.bisect(Xc, u);
                return i == Xc.length ? [t.year, Xu(n.map(function(n) {
                    return n / 31536e6
                }), e)[2]] : i ? t[u / Xc[i - 1] < Xc[i] / u ? i - 1 : i] : [Wc, Xu(n, e)[2]]
            }
            return r.invert = function(t) {
                ...
                function e(e) {
                    return !isNaN(e) && !n.range(e, Ki(+e + 1), t).length
                }
                var i = r.domain(),
                    a = Uu(i),
                    o = null == n ? u(a, 10) : "number" == typeof n && u(a, n);
                return o && (n = o[0], t = o[1]), r.domain(Hu(i, t > 1 ? {
                    floor: function(t) {
                        for (; e(t = n.floor(t));) t = Ki(t - 1);
                        return t
                    },
                    ceil: function(t) {
                        for (; e(t = n.ceil(t));) t = Ki(+t + 1);
                        return t
                    }
                } : n))
                ...
                var e = Uu(r.domain()),
                    i = null == n ? u(e, 10) : "number" == typeof n ? u(e, n) : !n.range && [{
                        ...
                        t];
                return i && (n = i[0], t = i[1]), n.range(e[0], Ki(+e[1] + 1), 1 > t ? 1 : t)
        ...
        if (Date.now || (Date.now = function() {
            ...
            var oa = this.Element.prototype,
                ca = oa.setAttribute,
                la = oa.setAttributeNS,
                sa = this.CSSStyleDeclaration.prototype,
                fa = sa.setProperty;
            oa.setAttribute = function(n, t) {
                ca.call(this, n, t + "")
            }, oa.setAttributeNS = function(n, t, e) {
                la.call(this, n, t, e + "")
        ...
        ta.ascending = e, ta.descending = function(n, t) {
            ...
            var e, i = 0,
                ...
                o = -1,
                c = a;
            if (1 === arguments.length) for (; ++o < a;) u(e = r(n[o])) ? i += e : --c;
            else for (; ++o < a;) u(e = r(t.call(n, n[o], o))) ? i += e : --c;
            return c ? i / c : void 0
            ...
            var i, a = [],
                o = n.length,
                c = -1;
            if (1 === arguments.length) for (; ++c < o;) u(i = r(n[c])) && a.push(i);
            else for (; ++c < o;) u(i = r(t.call(n, n[c], c))) && a.push(i);
            return a.length ? ta.quantile(a.sort(e), .5) : void 0
            ...
            var e, i, a = n.length,
                ...
                l = -1,
                s = 0;
            if (1 === arguments.length) for (; ++l < a;) u(e = r(n[l])) && (i = e - o, o += i / ++s, c += i * (e - o));
            else for (; ++l < a;) u(e = r(t.call(n, n[l], l))) && (i = e - o, o += i / ++s, c += i * (e - o));
        ...
        ta.bisectLeft = ha.left, ta.bisect = ta.bisectRight = ha.right, ta.bisector = function(n) {
            ...
            for (var n = -1, t = ta.min(arguments, a), e = new Array(t); ++n < t;) for (var r, u = -1, i = e[n] = new Array(r); ++u < r;) i[u] = arguments[u][n];
            return e
        ...
        c(l, {
            ...
            function n(t, a, o) {
                ...
                for (var c, s, f, h, g = -1, p = a.length, v = i[o++], d = new l; ++g < p;)(h = d.get(c = v(s = a[g]))) ? h.push(s) : d.set(c, [s]);
        ...
        _a.select = function(n) {
            ...
            for (var a = -1, o = this.length; ++a < o;) {
                ...
                for (var c = -1, l = r.length; ++c < l;)(u = r[c]) ? (t.push(e = n.call(u, u.__data__, c, a)), e && "__data__" in u && (e.__data__ = u.__data__)) : t.push(null)
            }
            return E(i)
        }, _a.selectAll = function(n) {
            var t, e, r = [];
            n = C(n);
            for (var u = -1, i = this.length; ++u < i;) for (var a = this[u], o = -1, c = a.length; ++o < c;)(e = a[o]) && (r.push(t = ra(n.call(e, e.__data__, o, u))), t.parentNode = e);
            return E(r)
        };
        var wa = {
        ...
        ta.ns = {
            ...
            function e(n, e) {
                ...
                if (t) {
                    ...
                    for (r = -1; ++r < a;) m.get(y[r]) !== !0 && (v[r] = n[r])
                } else {
                    for (r = -1; ++r < h;) u = n[r], i = e[r], u ? (u.__data__ = i, g[r] = u) : p[r] = H(i);
                    for (; f > r; ++r) p[r] = H(e[r]);
                    for (; a > r; ++r) v[r] = n[r]
                }
                p.update = g, p.parentNode = g.parentNode = v.parentNode = n.parentNode, o.push(p), c.push(g), s.push(v)
            }
            var r, u, i = -1,
                a = this.length;
            if (!arguments.length) {
            ...
            for (var i = 0, a = this.length; a > i; i++) {
                ...
                for (var o = 0, c = e.length; c > o; o++)(r = e[o]) && n.call(r, r.__data__, o, i) && t.push(r)
            }
            return E(u)
        }, _a.order = function() {
        ...
        ta.selection.enter = Z, ta.selection.enter.prototype = Sa, Sa.append = _a.append, Sa.empty = _a.empty, Sa.node = _a.node, Sa.call = _a.call, Sa.size = _a.size, Sa.select = function(n) {
            for (var t, e, r, u, i, a = [], o = -1, c = this.length; ++o < c;) {
                ...
                for (var l = -1, s = u.length; ++l < s;)(i = u[l]) ? (t.push(r[l] = e = n.call(u.parentNode, i.__data__, l, o)), e.__data__ = i.__data__) : t.push(null)
            }
            return E(a)
            ...
            var e;
            return "string" == typeof t ? (e = [Ma(t, ua)], e.parentNode = ua.documentElement) : (e = [t], e.parentNode = n(t)), E([e])
        }, ta.selectAll = function(n) {
            var t;
            return "string" == typeof n ? (t = ra(xa(n, ua)), t.parentNode = ua.documentElement) : (t = n, t.parentNode = null), E([t])
        ...
        var Aa = this.navigator && /WebKit/.test(this.navigator.userAgent) ? -1 : 0;
        ta.touch = function(n, t, e) {
            ...
            function e(n, t, e, i, a) {
                return function() {
                    ...
                    function c() {
                        t(h, v) && (m.on(i + d, null).on(a + d, null), y(p && ta.event.target === f), g({
                            type: "dragend"
                        }))
                    }
                    var l, s = this,
                        ...
                        v = n(),
                        d = ".drag" + (null == v ? "" : "-" + v),
                        m = ta.select(e(f)).on(i + d, o).on(a + d, c),
                        y = W(f),
                        M = t(h, v);
            ...
            var r = N(n, "drag", "dragstart", "dragend"),
                ...
                a = e(G, ta.touch, y, "touchmove", "touchend");
        ...
        ta.interpolateZoom = function(n, t) {
            function e(n) {
                ...
                if (m) {
                    var e = rn(v),
                        a = i / (ja * h) * (e * un(Ua * t + v) - en(v));
                    return [r + a * l, u + a * s, i * e / rn(Ua * t + v)]
                }
            ...
            function a(t, e, r, a) {
                t.__chart__ = {
                    ...
                    y: k.y,
                    k: k.k
                }, u(Math.pow(2, a)), i(d = e, r), t = ta.select(t), C > 0 && (t = t.transition().duration(C)), t.call(n.event)
            }
            function o() {
            ...
            function f() {
                function n() {
                    f = 1, i(ta.mouse(u), g), l(o)
                }
                function r() {
                    h.on(L, null).on(T, null), p(f && ta.event.target === a), s(o)
                }
                var u = this,
                    a = ta.event.target,
                    o = D.of(u, arguments),
            ...
            function h() {
                ...
                function t() {
                    ...
                    ta.select(t).on(x, r).on(b, o), _.push(t);
                ...
                function r() {
                    var n, t, e, r, a = ta.touches(p);
                    Pc.call(p);
                    for (var o = 0, c = a.length; c > o; ++o, r = null) if (e = a[o], r = d[e.identifier]) {
                        if (t) break;
                        n = e, t = r
                    }
                    if (r) {
                ...
                function o() {
                    ...
                    ta.selectAll(_).on(y, null), w.on(q, f).on(R, h), N(), s(v)
                }
                var g, p = this,
                    v = D.of(p, arguments),
                    d = {},
            ...
            function g() {
                ...
                y ? clearTimeout(y) : (Pc.call(this), v = e(d = m || ta.mouse(this)), c(n)), y = setTimeout(function() {
                    y = null, s(n)
            ...
            function p() {
                ...
                a(this, n, e(n), ta.event.shiftKey ? Math.ceil(t) - 1 : Math.floor(t) + 1)
            }
            ...
            return Oa || (Oa = "onwheel" in ua ? (Ha = function() {
                ...
                n.each(function() {
                    var n = D.of(this, arguments),
                        t = k;
                    Rc ? ta.select(this).transition().each("start.zoom", function() {
                        k = this.__chart__ || {
                                x: 0,
                                y: 0,
                                k: 1
                        ...
                        var e = E[0],
                            ...
                            u = d ? d[0] : e / 2,
                            i = d ? d[1] : r / 2,
                            a = ta.interpolateZoom([(u - k.x) / k.k, (i - k.y) / k.k, e / k.k], [(u - t.x) / t.k, (i - t.y) / t.k, e / t.k]);
                        return function(t) {
                            var r = a(t),
                                o = e / r[2];
                            this.__chart__ = k = {
                ...
                return arguments.length ? (A = null == t ? Ia : [+t[0], +t[1]], n) : A
            }, n.center = function(t) {
        ...
        var Ha, Oa, Ia = [0, 1 / 0];
        ta.color = on, on.prototype.toString = function() {
            return this.rgb() + ""
        }, ta.hsl = cn;
        var Ya = cn.prototype = new on;
        ...
        var Za = sn.prototype = new on;
        Za.brighter = function(n) {
            return new sn(this.h, this.c, Math.min(100, this.l + Va * (arguments.length ? n : 1)))
        }, Za.darker = function(n) {
            return new sn(this.h, this.c, Math.max(0, this.l - Va * (arguments.length ? n : 1)))
        }, Za.rgb = function() {
        ...
        var Va = 18,
            ...
            $a = 1,
            Ba = 1.08883,
            Wa = hn.prototype = new on;
        Wa.brighter = function(n) {
            return new hn(Math.min(100, this.l + Va * (arguments.length ? n : 1)), this.a, this.b)
        }, Wa.darker = function(n) {
            return new hn(Math.max(0, this.l - Va * (arguments.length ? n : 1)), this.a, this.b)
        }, Wa.rgb = function() {
            return gn(this.l, this.a, this.b)
        }, ta.rgb = yn;
        var Ja = yn.prototype = new on;
        ...
        Ga.forEach(function(n, t) {
            Ga.set(n, Mn(t))
        }), ta.functor = En, ta.xhr = An(y), ta.dsv = function(n, t) {
            function e(n, e, i) {
            ...
            return e.parse = function(n, t) {
                ...
                for (var r, u, i = {}, a = {}, o = [], l = n.length, s = 0, f = 0;
                     (r = e()) !== a;) {
        ...
        var Ka, Qa, no, to, eo, ro = this[x(this, "requestAnimationFrame")] ||
            function(n) {
                setTimeout(n, 17)
            };
        ta.timer = function(n, t, e) {
            ...
            Qa ? Qa.n = i : Ka = i, Qa = i, no || (to = clearTimeout(to), no = 1, ro(Ln))
        }, ta.timer.flush = function() {
            Tn(), Rn()
        }, ta.round = function(n, t) {
            return t ? Math.round(n * (t = Math.pow(10, t))) / t : Math.round(n)
        };
        var uo = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Pn);
        ta.formatPrefix = function(n, t) {
            var e = 0;
            return n && (0 > n && (n *= -1), t && (n = ta.round(n, Dn(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max(-24, Math.min(24, 3 * Math.floor((e - 1) / 3)))), uo[8 + e / 3]
        };
        var io = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
            ao = ta.map({
                b: function(n) {
                ...
                r: function(n, t) {
                    return (n = ta.round(n, Dn(n, t))).toFixed(Math.max(0, Math.min(20, Dn(n * (1 + 1e-15), t))))
                }
            }),
            oo = ta.time = {},
            co = Date;
        ...
        oo.year = Hn(function(n) {
            return n = oo.day(n), n.setMonth(0, 1), n
        }, function(n, t) {
            n.setFullYear(n.getFullYear() + t)
        }, function(n) {
            return n.getFullYear()
        }), oo.years = oo.year.range, oo.years.utc = oo.year.utc.range, oo.day = Hn(function(n) {
            var t = new co(2e3, 0);
            ...
            return n.getDate() - 1
        }), oo.days = oo.day.range, oo.days.utc = oo.day.utc.range, oo.dayOfYear = function(n) {
            var t = oo.year(n);
            return Math.floor((n - t - 6e4 * (n.getTimezoneOffset() - t.getTimezoneOffset())) / 864e5)
        }, ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach(function(n, t) {
            t = 7 - t;
            var e = oo[n] = Hn(function(n) {
                return (n = oo.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7), n
            }, function(n, t) {
                n.setDate(n.getDate() + 7 * Math.floor(t))
            }, function(n) {
                var e = oo.year(n).getDay();
                return Math.floor((oo.dayOfYear(n) + (e + t) % 7) / 7) - (e !== t)
            });
            oo[n + "s"] = e.range, oo[n + "s"].utc = e.utc.range, oo[n + "OfYear"] = function(n) {
                var e = oo.year(n).getDay();
                return Math.floor((oo.dayOfYear(n) + (e + t) % 7) / 7)
            }
        }), oo.week = oo.sunday, oo.weeks = oo.sunday.range, oo.weeks.utc = oo.sunday.utc.range, oo.weekOfYear = oo.sundayOfYear;
        var so = {
                "-": "",
                _: " ",
                0: "0"
        ...
        ta.format = go.numberFormat, ta.geo = {}, lt.prototype = {
            s: 0,
            t: 0,
            add: function(n) {
                st(n, this.t, po), st(po.s, this.s, this), this.s ? this.t += po.t : this.s = po.t
            },
            reset: function() {
                this.s = this.t = 0
            },
        ...
        ta.geo.stream = function(n, t) {
            n && vo.hasOwnProperty(n.type) ? vo[n.type](n, t) : ft(n, t)
        };
        var vo = {
                ...
                FeatureCollection: function(n, t) {
                    for (var e = n.features, r = -1, u = e.length; ++r < u;) ft(e[r].geometry, t)
                }
            },
            mo = {
                Sphere: function(n, t) {
                ...
                MultiLineString: function(n, t) {
                    for (var e = n.coordinates, r = -1, u = e.length; ++r < u;) ht(e[r], t, 0)
                },
                Polygon: function(n, t) {
                    gt(n.coordinates, t)
                },
                MultiPolygon: function(n, t) {
                    for (var e = n.coordinates, r = -1, u = e.length; ++r < u;) gt(e[r], t)
                },
                GeometryCollection: function(n, t) {
                    for (var e = n.geometries, r = -1, u = e.length; ++r < u;) ft(e[r], t)
                }
            };
        ta.geo.area = function(n) {
            return yo = 0, ta.geo.stream(n, xo), yo
        };
        var yo, Mo = new lt,
            xo = {
                sphere: function() {
                ...
                lineEnd: b,
                polygonStart: function() {
                    Mo.reset(), xo.lineStart = pt
                },
                polygonEnd: function() {
                    var n = 2 * Mo;
                    yo += 0 > n ? 4 * qa + n : n, xo.lineStart = xo.lineEnd = xo.point = b
                }
            };
        ta.geo.bounds = function() {
            ...
            function a() {
                u(v, d), xo.lineEnd(), ga(y) > Ca && (s = -(h = 180)), x[0] = s, x[1] = h, m = null
            }
            function o(n, t) {
            ...
            var s, f, h, g, p, v, d, m, y, M, x, b = {
                ...
                lineEnd: r,
                polygonStart: function() {
                    b.point = u, b.lineStart = i, b.lineEnd = a, y = 0, xo.polygonStart();
                },
                polygonEnd: function() {
                    xo.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r, 0 > Mo ? (s = -(h = 180), f = -(g = 90)) : y > Ca ? g = 90 : -Ca > y && (f = -90), x[0] = s, x[1] = h
                }
            };
            return function(n) {
            ...
            bo = _o = wo = So = ko = No = Eo = Ao = Co = zo = qo = 0, ta.geo.stream(n, Lo);
            var t = Co,
                e = zo,
                r = qo,
                u = t * t + e * e + r * r;
            return za > u && (t = No, e = Eo, r = Ao, Ca > _o && (t = wo, e = So, r = ko), u = t * t + e * e + r * r, za > u) ? [NaN, NaN] : [Math.atan2(e, t) * Pa, tn(r / Math.sqrt(u)) * Pa]
        };
        var bo, _o, wo, So, ko, No, Eo, Ao, Co, zo, qo, Lo = {
                sphere: b,
                point: wt,
                lineStart: kt,
                lineEnd: Nt,
        ...
        ta.geo.clipExtent = function() {
            var n, t, e, r, u, i, a = {
                ...
                extent: function(o) {
                    return arguments.length ? (i = Yt(n = +o[0][0], t = +o[0][1], e = +o[1][0], r = +o[1][1]), u && (u.valid = !1, u = null), a) : [
                        [n, t],
                        [e, r]
                    ]
                }
            ...
            var t, e, r, u, i = ta.geo.albers(),
                a = ta.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
                o = ta.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
                c = {
                    point: function(n, e) {
                        t = [n, e]
                    }
            ...
            return n.invert = function(n) {
                ...
                ]).stream(c).point, u = o.translate([s - .205 * l, f + .212 * l]).clipExtent([
                    [s - .214 * l + Ca, f + .166 * l + Ca],
                    [s - .115 * l - Ca, f + .234 * l - Ca]
                ]).stream(c).point, n
            }, n.scale(1070)
        };
        var Do, Po, Uo, jo, Fo, Ho, Oo = {
                point: b,
                lineStart: b,
                lineEnd: b,
                polygonStart: function() {
                    Po = 0, Oo.lineStart = Xt
                },
                polygonEnd: function() {
                    Oo.lineStart = Oo.lineEnd = Oo.point = b, Do += ga(Po / 2)
                }
            },
            Io = {
                point: $t,
            ...
            Yo = {
                ...
                polygonEnd: function() {
                    Yo.point = Jt, Yo.lineStart = Gt, Yo.lineEnd = Kt
                }
            };
        ta.geo.path = function() {
            function n(n) {
                return n && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), a && a.valid || (a = u(i)), ta.geo.stream(n, a)), i.result()
            }
            function t() {
                return a = null, n
            }
            ...
            return n.area = function(n) {
                return Do = 0, ta.geo.stream(n, u(Oo)), Do
            }, n.centroid = function(n) {
                return wo = So = ko = No = Eo = Ao = Co = zo = qo = 0, ta.geo.stream(n, u(Yo)), qo ? [Co / qo, zo / qo] : Ao ? [No / Ao, Eo / Ao] : ko ? [wo / ko, So / ko] : [NaN, NaN]
            }, n.bounds = function(n) {
                return Fo = Ho = -(Uo = jo = 1 / 0), ta.geo.stream(n, u(Io)), [
                    [Uo, jo],
                    [Fo, Ho]
                ]
            }, n.projection = function(n) {
                return arguments.length ? (u = (e = n) ? n.stream || ee(n) : y, t()) : e
            }, n.context = function(n) {
                return arguments.length ? (i = null == (r = n) ? new Bt : new ne(n), "function" != typeof o && i.pointRadius(o), t()) : r
        ...
        }, ta.geo.projection = ie, ta.geo.projectionMutator = ae, (ta.geo.equirectangular = function() {
            return ie(ce)
        }).raw = ce.invert = ce, ta.geo.rotation = function(n) {
            function t(t) {
                return t = n(t[0] * Da, t[1] * Da), t[0] *= Pa, t[1] *= Pa, t
            }
            return n = se(n[0] % 360 * Da, n[1] * Da, n.length > 2 ? n[2] * Da : 0), t.invert = function(t) {
                return t = n.invert(t[0] * Da, t[1] * Da), t[0] *= Pa, t[1] *= Pa, t
            }, t
        }, le.invert = ce, ta.geo.circle = function() {
            function n() {
                var n = "function" == typeof r ? r.apply(this, arguments) : r,
                    t = se(-n[0] * Da, -n[1] * Da, 0).invert,
                    u = [];
            ...
            return n.origin = function(t) {
                ...
                return arguments.length ? (e = pe((t = +r) * Da, u * Da), n) : t
            }, n.precision = function(r) {
                return arguments.length ? (e = pe(t * Da, (u = +r) * Da), n) : u
            }, n.angle(90)
            ...
            function t() {
                return ta.range(Math.ceil(i / d) * d, u, d).map(h).concat(ta.range(Math.ceil(l / m) * m, c, m).map(g)).concat(ta.range(Math.ceil(r / p) * p, e, p).filter(function(n) {
                    return ga(n % d) > Ca
                }).map(s)).concat(ta.range(Math.ceil(o / v) * v, a, v).filter(function(n) {
                    return ga(n % m) > Ca
                }).map(f))
            }
            var e, r, u, i, a, o, c, l, s, f, h, g, p = 10,
                v = p,
                d = 90,
                m = 360,
                y = 2.5;
            return n.lines = function() {
                ...
                return arguments.length ? (y = +t, s = de(o, a, 90), f = me(r, e, y), h = de(l, c, 90), g = me(i, u, y), n) : y
            }, n.majorExtent([
                [-180, -90 + Ca],
                [180, 90 - Ca]
            ]).minorExtent([
            ...
            return xe(n[0] * Da, n[1] * Da, t[0] * Da, t[1] * Da)
        }, ta.geo.length = function(n) {
            return Zo = 0, ta.geo.stream(n, Vo), Zo
        };
        var Zo, Vo = {
                sphere: b,
                point: b,
        ...
        (ta.geo.azimuthalEquidistant = function() {
            return ie($o)
        }).raw = $o, (ta.geo.conicConformal = function() {
            return Zt(we)
        }).raw = we, (ta.geo.conicEquidistant = function() {
            return Zt(Se)
        }).raw = Se;
        var Bo = _e(function(n) {
            return 1 / n
        }, Math.atan);
        (ta.geo.gnomonic = function() {
            return ie(Bo)
        }).raw = Bo, ke.invert = function(n, t) {
        ...
        }).raw = Ee, ta.geom = {}, ta.geom.hull = function(n) {
            function t(n) {
                ...
                for (o.sort(qe), t = 0; a > t; t++) c.push([o[t][0], -o[t][1]]);
                var l = ze(o),
                    s = ze(c),
                    f = s[0] === l[0],
        ...
        var Go = ta.geom.polygon.prototype = [];
        Go.area = function() {
            ...
            for (var t, e, r, u, i, a, o = Re(n), c = -1, l = this.length - Re(this), s = this[l - 1]; ++c < l;) {
                for (t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - o) - 1], e = -1; ++e < r;) a = t[e], Le(a, s, u) ? (Le(i, s, u) || n.push(Te(i, a, s, u)), n.push(a)) : Le(i, s, u) && n.push(Te(i, a, s, u)), i = a;
                o && n.push(n[0]), s = u
            }
            return n
        };
        var Ko, Qo, nc, tc, ec, rc = [],
            uc = [];
        Ie.prototype.prepare = function() {
            ...
            insert: function(n, t) {
                ...
                if (n) {
                    ...
                    e = n
                } else this._ ? (n = ir(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, this._ = t, e = null);
                for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C;) r = e.U, e === r.L ? (u = r.R, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.R && (rr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, ur(this, r))) : (u = r.L, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.L && (ur(this, e), n = e, e = n.U), e.C = !1, r.C = !0, rr(this, r))), e = n.U;
                this._.C = !1
            },
            remove: function(n) {
                ...
                var t, e, r, u = n.U,
                    i = n.L,
                    a = n.R;
                if (e = i ? a ? ir(a) : i : a, u ? u.L === n ? u.L = e : u.R = e : this._ = e, i && a ? (r = e.C, e.C = n.C, e.L = i, i.U = e, e !== a ? (u = e.U, e.U = n.U, n = e.R, u.L = n, e.R = a, a.U = e) : (e.U = u, u = e, n = e.R)) : (r = n.C, n = e), n && (n.U = u), !r) {
                    if (n && n.C) return void(n.C = !1);
                    do {
                        if (n === this._) break;
                        if (n === u.L) {
                            if (t = u.R, t.C && (t.C = !1, u.C = !0, rr(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
                                t.R && t.R.C || (t.L.C = !1, t.C = !0, ur(this, t), t = u.R), t.C = u.C, u.C = t.R.C = !1, rr(this, u), n = this._;
                                break
                            }
                        } else if (t = u.L, t.C && (t.C = !1, u.C = !0, ur(this, u), t = u.L), t.L && t.L.C || t.R && t.R.C) {
                            t.L && t.L.C || (t.R.C = !1, t.C = !0, rr(this, t), t = u.L), t.C = u.C, u.C = t.L.C = !1, ur(this, u), n = this._;
                            break
                        }
                        t.C = !0, n = u, u = u.U
                    } while (!n.C);
            ...
            function t(n) {
                var t = new Array(n.length),
                    ...
                    i = o[1][0],
                    a = o[1][1];
                return ar(e(n), o).cells.forEach(function(e, o) {
                    var c = e.edges,
                        l = e.site,
                        s = t[o] = c.length ? c.map(function(n) {
                            var t = n.start();
                            return [t.x, t.y]
                        }) : l.x >= r && l.x <= i && l.y >= u && l.y <= a ? [
                            [r, a],
                            [i, a],
                            [i, u],
                            [r, u]
            ...
            return n ? t(n) : (t.links = function(n) {
                ...
                return ar(e(n)).cells.forEach(function(e, r) {
                    for (var u, i, a = e.site, o = e.edges.sort(Ze), c = -1, l = o.length, s = o[l - 1].edge, f = s.l === a ? s.r : s.l; ++c < l;) u = s, i = f, s = o[c].edge, f = s.l === a ? s.r : s.l, r < i.i && r < f.i && cr(a, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]])
                }), t
            }, t.x = function(n) {
                ...
                return arguments.length ? (o = null == n ? ic : n, t) : o === ic ? null : o
            }, t.size = function(n) {
                return arguments.length ? t.clipExtent(n && [
                        [0, 0], n]) : o === ic ? null : o && o[1]
            }, t)
        };
        var ic = [
            [-1e6, -1e6],
        ...
        ta.geom.delaunay = function(n) {
            ...
            function i(n) {
                function i(n, t, e, r, u, i, a, o) {
                    if (!isNaN(e) && !isNaN(r)) if (n.leaf) {
                        var c = n.x,
                            s = n.y;
                        if (null != c) if (ga(c - e) + ga(s - r) < .01) l(n, t, e, r, u, i, a, o);
                        else {
                            var f = n.point;
                            n.x = n.y = n.point = null, l(n, f, c, s, u, i, a, o), l(n, t, e, r, u, i, a, o)
                ...
                function l(n, t, e, r, u, a, o, c) {
                    var l = .5 * (u + o),
                        ...
                        h = r >= s,
                        g = h << 1 | f;
                    n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = fr()), f ? u = l : o = l, h ? a = s : c = s, i(n, t, e, r, u, a, o, c)
                }
            ...
            var a, o = Ae,
                c = Ce;
            return (a = arguments.length) ? (o = lr, c = sr, 3 === a && (u = e, r = t, e = t = 0), i(n)) : (i.x = function(n) {
        ...
        }, ta.interpolateRgb = pr, ta.interpolateObject = vr, ta.interpolateNumber = dr, ta.interpolateString = mr;
        var ac = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
            oc = new RegExp(ac.source, "g");
        ta.interpolate = yr, ta.interpolators = [function(n, t) {
            var e = typeof t;
            return ("string" === e ? Ga.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t) ? pr : mr : t instanceof on ? pr : Array.isArray(t) ? Mr : "object" === e && isNaN(t) ? vr : dr)(n, t)
        }], ta.interpolateArray = Mr;
        var cc = function() {
                return y
            },
            lc = ta.map({
        ...
        ta.ease = function(n) {
            ...
            return e = lc.get(e) || cc, r = sc.get(r) || y, xr(r(e.apply(null, ea.call(arguments, 1))))
        }, ta.interpolateHcl = Tr, ta.interpolateHsl = Rr, ta.interpolateLab = Dr, ta.interpolateRound = Pr, ta.transform = function(n) {
        ...
        ta.interpolateTransform = Or, ta.layout = {}, ta.layout.bundle = function() {
            return function(n) {
            ...
            function t(n) {
                n.px = ta.event.x, n.py = ta.event.y, o.resume()
            }
            var e, r, u, i, a, o = {},
            ...
            return o.tick = function() {
                ...
                var t, e, o, f, h, p, d, y, x, b = m.length,
                    _ = M.length;
                for (e = 0; _ > e; ++e) o = M[e], f = o.source, h = o.target, y = h.x - f.x, x = h.y - f.y, (p = y * y + x * x) && (p = r * i[e] * ((p = Math.sqrt(p)) - u[e]) / p, y *= p, x *= p, h.x -= y * (d = f.weight / (h.weight + f.weight)), h.y -= x * d, f.x += y * (d = 1 - d), f.y += x * d);
                if ((d = r * v) && (y = l[0] / 2, x = l[1] / 2, e = -1, d)) for (; ++e < b;) o = m[e], o.x += (y - o.x) * d, o.y += (x - o.y) * d;
                if (g) for (Gr(t = ta.geom.quadtree(m), r, a), e = -1; ++e < b;)(o = m[e]).fixed || t.visit(n(o));
            ...
            }, o.chargeDistance = function(n) {
                return arguments.length ? (p = n * n, o) : Math.sqrt(p)
            }, o.gravity = function(n) {
                return arguments.length ? (v = +n, o) : v
            }, o.theta = function(n) {
                return arguments.length ? (d = n * n, o) : Math.sqrt(d)
            }, o.alpha = function(n) {
                ...
                function n(n, r) {
                    if (!e) {
                        for (e = new Array(c), o = 0; c > o; ++o) e[o] = [];
                        for (o = 0; s > o; ++o) {
                            var u = M[o];
                            e[u.source.index].push(u.target), e[u.target.index].push(u.source)
                        }
                    }
                    for (var i, a = e[t], o = -1, l = a.length; ++o < l;) if (!isNaN(i = a[o][n])) return i;
                ...
                return e || (e = ta.behavior.drag().origin(y).on("dragstart.force", $r).on("drag.force", t).on("dragend.force", Br)), arguments.length ? void this.on("mouseover.force", Wr).on("mouseout.force", Jr).call(e) : e
            }, ta.rebind(o, c, "on")
        };
        var hc = 20,
            gc = 1,
        ...
        ta.layout.hierarchy = function() {
            function n(u) {
                var i, a = [u],
                    o = [];
                for (u.depth = 0; null != (i = a.pop());) if (o.push(i), (l = e.call(n, i, i.depth)) && (c = l.length)) {
                    for (var c, l, s; --c >= 0;) a.push(s = l[c]), s.parent = i, s.depth = i.depth + 1;
                    r && (i.value = 0), i.children = l
                } else r && (i.value = +r.call(n, i, i.depth) || 0), delete i.children;
                return nu(u, function(n) {
                    var e, u;
        ...
        ta.layout.stack = function() {
            ...
            return n.values = function(e) {
                ...
                return arguments.length ? (e = "function" == typeof t ? t : dc.get(t) || cu, n) : e
            }, n.offset = function(t) {
                return arguments.length ? (r = "function" == typeof t ? t : mc.get(t) || lu, n) : r
            }, n.x = function(t) {
                return arguments.length ? (i = t, n) : i
            }, n.y = function(t) {
        ...
        var dc = ta.map({
                "inside-out": function(n) {
                    var t, e, r = n.length,
                        u = n.map(su),
                        i = n.map(fu),
                        a = ta.range(r).sort(function(n, t) {
                            return u[n] - u[t]
                        }),
                        o = 0,
                        c = 0,
            ...
            mc = ta.map({
                ...
                wiggle: function(n) {
                    var t, e, r, u, i, a, o, c, l, s = n.length,
                        f = n[0],
                        h = f.length,
                        g = [];
        ...
        ta.layout.histogram = function() {
            function n(n, i) {
                for (var a, o, c = [], l = n.map(e, this), s = r.call(this, l, i), f = u.call(this, s, l, i), i = -1, h = l.length, g = f.length - 1, p = t ? 1 : 1 / h; ++i < g;) a = c[i] = [], a.dx = f[i + 1] - (a.x = f[i]), a.y = 0;
                if (g > 0) for (i = -1; ++i < h;) o = l[i], o >= s[0] && o <= s[1] && (a = c[ta.bisect(f, o, 1, g) - 1], a.y += p, a.push(n[i]));
                return c
            }
            var t = !0,
                e = Number,
            ...
            function n(n, i) {
                ...
                if (o.x = o.y = 0, nu(o, function(n) {
                        n.r = +s(n.value)
                    }), nu(o, xu), r) {
                    var f = r * (t ? 1 : Math.max(2 * o.r / c, 2 * o.r / l)) / 2;
                    nu(o, function(n) {
                        n.r += f
                    }), nu(o, xu), nu(o, function(n) {
                        n.r -= f
                    })
                }
                return wu(o, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * o.r / c, 2 * o.r / l)), a
            }
            var t, e = ta.layout.hierarchy().sort(du),
                r = 0,
                u = [1, 1];
            ...
            function n(n, u) {
                var s = a.call(this, n, u),
                    f = s[0],
                    h = t(f);
                if (nu(h, e), h.parent.m = -h.z, Qr(h, r), l) Qr(f, i);
                else {
                    var g = f,
                        p = f,
                        v = f;
            ...
            function u(n, t, e) {
                if (t) {
                    for (var r, u = n, i = n, a = t, c = u.parent.children[0], l = u.m, s = i.m, f = a.m, h = c.m; a = Eu(a), u = Nu(u), a && u;) c = Nu(c), i = Eu(i), i.a = n, r = a.z + f - u.z - l + o(a._, u._), r > 0 && (Au(zu(a, n, e), n, r), l += r, s += r), f += a.m, l += u.m, h += c.m, s += i.m;
                    a && !Eu(i) && (i.t = a, i.m += f - s), u && !Nu(c) && (c.t = u, c.m += l - h, e = n)
                }
                return e
            }
            function i(n) {
            ...
            var a = ta.layout.hierarchy().sort(null).value(null),
                o = ku,
                c = [1, 1],
                l = null;
            ...
            function n(n, i) {
                ...
                nu(c, function(n) {
                    var t = n.children;
                    t && t.length ? (n.x = Lu(t), n.y = qu(t)) : (n.x = a ? l += e(n, a) : 0, n.y = 0, a = n)
                });
                var s = Tu(c),
                    f = Ru(c),
                    h = s.x - e(s, f) / 2,
            ...
            function t(e) {
                ...
                if (i && i.length) {
                    ...
                    for (n(h, l.dx * l.dy / e.value), s.area = 0;
                         (c = h.length) > 0;) s.push(a = h[c - 1]), s.area += a.area, "squarify" !== g || (o = r(s, v)) <= p ? (h.pop(), p = o) : (s.area -= s.pop().area, u(s, v, l, !1), v = Math.min(l.dx, l.dy), s.length = s.area = 0, p = 1 / 0);
            ...
            function u(n, t, e, r) {
                var u, i = -1,
                    ...
                    s = t ? c(n.area / t) : 0;
                if (t == e.dx) {
                    for ((r || s > e.dy) && (s = e.dy); ++i < a;) u = n[i], u.x = o, u.y = l, u.dy = s, o += u.dx = Math.min(e.x + e.dx - o, s ? c(u.area / s) : 0);
                    u.z = !0, u.dx += e.x + e.dx - o, e.y += s, e.dy -= s
                } else {
                    for ((r || s > e.dx) && (s = e.dx); ++i < a;) u = n[i], u.x = o, u.y = l, u.dx = s, l += u.dy = Math.min(e.y + e.dy - l, s ? c(u.area / s) : 0);
            ...
            return i.size = function(n) {
                ...
                function t(t) {
                    ...
                    return null == e ? Du(t) : Pu(t, "number" == typeof e ? [e, e, e, e] : e)
                }
                function e(t) {
                    return Pu(t, n)
                }
                ...
                var r;
                return f = null == (s = n) ? Du : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i
            }, i.round = function(n) {
        ...
        ta.scale.log = function() {
            return Gu(ta.scale.linear().domain([0, 1]), 10, !0, [1, 10])
        };
        var xc = ta.format(".0e"),
            bc = {
                floor: function(n) {
        ...
        ta.scale.pow = function() {
            return Ku(ta.scale.linear(), 1, [0, 1])
            ...
            return ta.scale.ordinal().range(_c)
        }, ta.scale.category20 = function() {
            return ta.scale.ordinal().range(wc)
        }, ta.scale.category20b = function() {
            return ta.scale.ordinal().range(Sc)
        }, ta.scale.category20c = function() {
            return ta.scale.ordinal().range(kc)
        };
        ...
        ta.scale.quantile = function() {
            ...
            function n() {
                var n = Math.max(0, +e.apply(this, arguments)),
                    ...
                    s = a.apply(this, arguments) - Ra,
                    f = o.apply(this, arguments) - Ra,
                    h = Math.abs(f - s),
                    g = s > f ? 0 : 1;
                ...
                var p, v, d, m, y, M, x, b, _, w, S, k, N = 0,
                    E = 0,
                    A = [];
                if ((m = (+c.apply(this, arguments) || 0) / 2) && (d = i === Nc ? Math.sqrt(n * n + l * l) : +i.apply(this, arguments), g || (E *= -1), l && (E = tn(d / l * Math.sin(m))), n && (N = tn(d / n * Math.sin(m)))), l) {
                    y = l * Math.cos(s + E), M = l * Math.sin(s + E), x = l * Math.cos(f - E), b = l * Math.sin(f - E);
                    var C = Math.abs(f - s - 2 * E) <= qa ? 0 : 1;
                    if (E && fi(y, M, x, b) === g ^ C) {
                        var z = (s + f) / 2;
                ...
                if (n) {
                    ...
                    var q = Math.abs(s - f + 2 * N) <= qa ? 0 : 1;
                    if (N && fi(_, w, S, k) === 1 - g ^ q) {
                        var L = (s + f) / 2;
                ...
                if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > .001) {
                    v = l > n ^ g ? 0 : 1;
                    var T = null == S ? [_, w] : null == x ? [y, M] : Te([y, M], [S, k], [x, b], [_, w]),
                        R = y - T[0],
                        D = M - T[1],
                        P = x - T[0],
                        U = b - T[1],
                    ...
                    if (null != x) {
                        var H = Math.min(p, (l - F) / (j + 1)),
                            O = hi(null == S ? [_, w] : [S, k], [y, M], l, H, g),
                            I = hi([x, b], [_, w], l, H, g);
                        p === H ? A.push("M", O[0], "A", H, ",", H, " 0 0,", v, " ", O[1], "A", l, ",", l, " 0 ", 1 - g ^ fi(O[1][0], O[1][1], I[1][0], I[1][1]), ",", g, " ", I[1], "A", H, ",", H, " 0 0,", v, " ", I[0]) : A.push("M", O[0], "A", H, ",", H, " 0 1,", v, " ", I[0])
                    } else A.push("M", y, ",", M);
                    if (null != S) {
                        var Y = Math.min(p, (n - F) / (j - 1)),
                            Z = hi([y, M], [S, k], n, -Y, g),
                            V = hi([_, w], null == x ? [y, M] : [x, b], n, -Y, g);
                        p === Y ? A.push("L", V[0], "A", Y, ",", Y, " 0 0,", v, " ", V[1], "A", n, ",", n, " 0 ", g ^ fi(V[1][0], V[1][1], Z[1][0], Z[1][1]), ",", 1 - g, " ", Z[1], "A", Y, ",", Y, " 0 0,", v, " ", Z[0]) : A.push("L", V[0], "A", Y, ",", Y, " 0 0,", v, " ", Z[0])
                    } else A.push("L", _, ",", w)
                } else A.push("M", y, ",", M), null != x && A.push("A", l, ",", l, " 0 ", C, ",", g, " ", x, ",", b), A.push("L", _, ",", w), null != S && A.push("A", n, ",", n, " 0 ", q, ",", 1 - g, " ", S, ",", k);
            ...
            return n.innerRadius = function(t) {
                ...
                return arguments.length ? (i = t == Nc ? Nc : En(t), n) : i
            }, n.startAngle = function(t) {
                ...
                var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
                    t = (+a.apply(this, arguments) + +o.apply(this, arguments)) / 2 - Ra;
        ...
        ta.svg.line.radial = function() {
        ...
        }, mi.reverse = yi, yi.reverse = mi, ta.svg.area = function() {
            return Di(y)
            ...
            return n.projection = function(n) {
                return arguments.length ? e(ji(t = n)) : t
            }, n
        }, ta.svg.symbol = function() {
            function n(n, r) {
                return (qc.get(t.call(this, n, r)) || Oi)(e.call(this, n, r))
            }
            var t = Hi,
                e = Fi;
        ...
        ta.svg.symbolTypes = qc.keys();
        var Lc = Math.sqrt(3),
            Tc = Math.tan(30 * Da);
        _a.transition = function(n) {
            for (var t, e, r = Rc || ++jc, u = Xi(n), i = [], a = Dc || {
                    time: Date.now(),
                    ease: kr,
                    delay: 0,
                    duration: 250
                ...
                i.push(t = []);
                for (var l = this[o], s = -1, f = l.length; ++s < f;)(e = l[s]) && $i(e, s, u, r, a), t.push(e)
            }
            return Yi(i, u, r)
        }, _a.interrupt = function(n) {
            return this.each(null == n ? Pc : Ii(Xi(n)))
        };
        var Rc, Dc, Pc = Ii(Xi()),
            Uc = [],
            jc = 0;
        Uc.call = _a.call, Uc.empty = _a.empty, Uc.node = _a.node, Uc.size = _a.size, ta.transition = function(n, t) {
            return n && n.transition ? Rc ? n.transition(t) : n : ta.selection().transition(n)
        }, ta.transition.prototype = Uc, Uc.select = function(n) {
            var t, e, r, u = this.id,
                i = this.namespace,
                a = [];
            n = A(n);
            for (var o = -1, c = this.length; ++o < c;) {
                a.push(t = []);
                for (var l = this[o], s = -1, f = l.length; ++s < f;)(r = l[s]) && (e = n.call(r, r.__data__, s, o)) ? ("__data__" in r && (e.__data__ = r.__data__), $i(e, s, i, u, r[i][u]), t.push(e)) : t.push(null)
            }
            return Yi(a, i, u)
            ...
            for (var l = -1, s = this.length; ++l < s;) for (var f = this[l], h = -1, g = f.length; ++h < g;) if (r = f[h]) {
                i = r[o][a], e = n.call(r, r.__data__, h, l), c.push(t = []);
                for (var p = -1, v = e.length; ++p < v;)(u = e[p]) && $i(u, p, o, a, i), t.push(u)
            }
            return Yi(c, o, a)
            ...
            for (var i = 0, a = this.length; a > i; i++) {
                u.push(t = []);
                for (var e = this[i], o = 0, c = e.length; c > o; o++)(r = e[o]) && n.call(r, r.__data__, o, i) && t.push(r)
            }
            return Yi(u, this.namespace, this.id)
            ...
            var a = "transform" == n ? Or : yr,
                o = ta.ns.qualify(n);
            return Zi(this, "attr." + n, t, o.local ? i : u)
            ...
            function i(e) {
                return null == e ? u : (e += "", function() {
                    ...
                    return i !== e && (u = yr(i, e), function(t) {
            ...
            if (arguments.length < 2) {
                var u = Dc,
                    i = Rc;
                try {
                    Rc = e, Y(this, function(t, u, i) {
                        Dc = t[r][e], n.call(t, t.__data__, u, i)
                    })
                } finally {
                    Dc = u, Rc = i
                }
            ...
            for (var n, t, e, r, u = this.id, i = ++jc, a = this.namespace, o = [], c = 0, l = this.length; l > c; c++) {
                o.push(n = []);
                for (var t = this[c], s = 0, f = t.length; f > s; s++)(e = t[s]) && (r = e[a][u], $i(e, s, a, i, {
                    time: r.time,
                    ease: r.ease,
            ...
            function n(n) {
                n.each(function() {
                    var n, l = ta.select(this),
                        ...
                        h = null == c ? f.ticks ? f.ticks.apply(f, o) : f.domain() : c,
            ...
            return n.scale = function(t) {
                ...
                return arguments.length ? (r = t in Hc ? t + "" : Fc, n) : r
            }, n.ticks = function() {
                return arguments.length ? (o = arguments, n) : o
        ...
        ta.svg.brush = function() {
            function n(t) {
                t.each(function() {
                    ...
                    var c, f = ta.transition(t),
                        h = ta.transition(a);
                    l && (c = ju(l), h.attr("x", c[0]).attr("width", c[1] - c[0]), r(f)), s && (c = ju(s), h.attr("y", c[0]).attr("height", c[1] - c[0]), u(f)), e(f)
                })
            }
            function e(n) {
            ...
            function i() {
                ...
                function d() {
                    var n = ta.mouse(b),
                        t = !1;
                    x && (n[0] += x[0], n[1] += x[1]), C || (ta.event.altKey ? (M || (M = [(f[0] + f[1]) / 2, (h[0] + h[1]) / 2]), q[0] = f[+(n[0] < M[0])], q[1] = h[+(n[1] < M[1])]) : M = null), E && m(n, l, 0) && (r(k), t = !0), A && m(n, s, 1) && (u(k), t = !0), t && (e(k), w({
                        type: "brush",
                        mode: C ? "move" : "resize"
                    }))
                }
                function m(n, t, e) {
                    var r, u, i = ju(t),
                        ...
                        v = e ? h : f,
                        d = v[1] - v[0];
                    return C && (c -= s, l -= d + s), r = (e ? p : g) ? Math.max(c, Math.min(l, n[e])) : n[e], C ? u = (r += s) + d : (M && (s = Math.max(c, Math.min(l, 2 * M[e] - r))), r > s ? (u = r, r = s) : u = s), v[0] != r || v[1] != u ? (e ? o = null : a = null, v[0] = r, v[1] = u, !0) : void 0
                }
                function y() {
            ...
            var a, o, c = N(n, "brushstart", "brush", "brushend"),
                l = null,
                s = null,
                f = [0, 0],
                h = [0, 0],
            ...
            return n.event = function(n) {
                n.each(function() {
                    var n = c.of(this, arguments),
                        ...
                        e = this.__chart__ || t;
                    this.__chart__ = t, Rc ? ta.select(this).transition().each("start.brush", function() {
        ...
        var Oc = {
            ...
            Yc = oo.format = go.timeFormat,
            Zc = Yc.utc,
            Vc = Zc("%Y-%m-%dT%H:%M:%S.%LZ");
        Yc.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Ji : Vc, Ji.parse = function(n) {
            var t = new Date(n);
            return isNaN(t) ? null : t
        }, Ji.toString = Vc.toString, oo.second = Hn(function(n) {
            return new co(1e3 * Math.floor(n / 1e3))
        }, function(n, t) {
            n.setTime(n.getTime() + 1e3 * Math.floor(t))
        }, function(n) {
            return n.getSeconds()
        }), oo.seconds = oo.second.range, oo.seconds.utc = oo.second.utc.range, oo.minute = Hn(function(n) {
            return new co(6e4 * Math.floor(n / 6e4))
        }, function(n, t) {
            n.setTime(n.getTime() + 6e4 * Math.floor(t))
        }, function(n) {
            return n.getMinutes()
        }), oo.minutes = oo.minute.range, oo.minutes.utc = oo.minute.utc.range, oo.hour = Hn(function(n) {
            var t = n.getTimezoneOffset() / 60;
            return new co(36e5 * (Math.floor(n / 36e5 - t) + t))
        }, function(n, t) {
            n.setTime(n.getTime() + 36e5 * Math.floor(t))
        }, function(n) {
            return n.getHours()
        }), oo.hours = oo.hour.range, oo.hours.utc = oo.hour.utc.range, oo.month = Hn(function(n) {
            return n = oo.day(n), n.setDate(1), n
        }, function(n, t) {
            n.setMonth(n.getMonth() + t)
        }, function(n) {
            return n.getMonth()
        }), oo.months = oo.month.range, oo.months.utc = oo.month.utc.range;
        var Xc = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
            ...
            Wc = {
                range: function(n, t, e) {
                    return ta.range(Math.ceil(n / e) * e, +t, e).map(Ki)
                },
                floor: y,
                ceil: y
            };
        $c.year = oo.year, oo.scale = function() {
            return Gi(ta.scale.linear(), $c, Bc)
        };
        ...
        Jc.year = oo.year.utc, oo.scale.utc = function() {
            return Gi(ta.scale.linear(), Jc, Gc)
        }, ta.text = An(function(n) {
            return n.responseText
        }), ta.json = function(n, t) {
            return Cn(n, "application/json", Qi, t)
        }, ta.html = function(n, t) {
            return Cn(n, "text/html", na, t)
        }, ta.xml = An(function(n) {
